export default function TrashCan({ className, size,onHandleClick }) {
    return (
        <svg
        ...
        >
            <g>
                <path
                    ...
                    fill="#ffffff"
                />
                <rect fill="#ffffff" height="317.885" width="19.868" x="246.173" y="126.511" />
                <polygon fill="#ffffff" points="206.884,443.757 186.551,126.493 166.722,127.753 187.056,445.017  " />
                <polygon fill="#ffffff" points="345.649,127.132 325.82,125.891 305.777,443.776 325.606,445.017  " />
            </g>
        </svg>
    );
}
